...
import { signIn, loginWithGoogle } from "../../firebase";
...
export default function Login() {
    ...
    // Function to sign in with google and navigate to home page
            ...
            <div className="container flex flex-col md:flex-row gap-10 md:gap-0 items-center min-h-[780px] justify-end">
                ...
                <div className="flex flex-col gap-12 max-w-92.5 w-full">
                    <div className="flex flex-col gap-6">
                        <h2 className="font-medium text-4xl">{t("loginPageTitle")}</h2>
                        <p>{t("enterDetails")}</p>
                    </div>
                    <form className="flex flex-col gap-10" onSubmit={handleLogin}>
                        ...
                        <div className="flex gap-4 justify-between items-center">
                            ...
                            <a className="text-s-red">{t("forgotPassword")}</a>
                        </div>
                    </form>
                    <Button width="w-full" onClick={handleGoogleLogin} background="bg-white" text="text-black" moreClasses="border border-black/40">
